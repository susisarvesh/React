...
function MineSarvs() {
  return (
      ...
      <div className='flex items-center flex-col'>
        ...
        <h2 className='mb-2 flex items-center justify-between'><span className='text-[30px] text-red-500 font-mono mr-2 '>#40</span> <span className='text-[20px]'>React Components</span></h2>
      </div>
      <div className='flex justify-between items-center '>
         <a href="https://github.com/susisarvesh" target="_blank" className='bg-slate-100 p-2 rounded-md text-[20px] border border-black font-mono flex items-center justify-between mr-2'>
